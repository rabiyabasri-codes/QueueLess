...
public final class ItemMenuBinding implements ViewBinding {
  ...
  private ItemMenuBinding(@NonNull MaterialCardView rootView, @NonNull MaterialButton btnAdd,
      @NonNull ImageView ivFood, @NonNull TextView tvName, @NonNull TextView tvPrice) {
  ...
  public static ItemMenuBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      return new ItemMenuBinding((MaterialCardView) rootView, btnAdd, ivFood, tvName, tvPrice);
    }
